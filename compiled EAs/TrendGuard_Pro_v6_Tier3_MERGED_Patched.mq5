...
// Broker GMT Offset (select closest to your broker's server time relative to GMT/UTC)
// Examples: -5 (New York EST winter), -3 (Brazil), 0 (London GMT), +2 (Cyprus), +8 (Singapore)
...
input BrokerGMTOffsetEnum TG3_BrokerGMTOffsetHours = GMT_0; // Broker offset from GMT/UTC
